...
```javascript
reBasename = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-basename@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/regexp-basename@v0.2.1-umd/browser.js"></script>
```
